...
const Leaderboard: React.FC = () => {
  const data = [
    { username: "Charlie", daysTaken: 70, longestStreak: 20 },
    { username: "Diana", daysTaken: 60, longestStreak: 18 },
    { username: "Grace", daysTaken: 55, longestStreak: 16 },
    { username: "Alice", daysTaken: 50, longestStreak: 15 },
    { username: "Eve", daysTaken: 45, longestStreak: 14 },
    { username: "Bob", daysTaken: 40, longestStreak: 12 },
    { username: "Frank", daysTaken: 35, longestStreak: 10 },
    { username: "Hannah", daysTaken: 30, longestStreak: 8 },
  ];
